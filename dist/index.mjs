...
function severityCountsLabel(counts) {
...
function renderChangeClassificationMarkdown(report) {
	...
	else for (const item of packagesWithFindings) lines.push("<details>", `<summary><code>${htmlFragment(item.packageId)}</code> — ${severityCountsLabel(severityCounts(item.findings))}</summary>`, "", item.summary, "", ...item.findings.map(findingLine), "", "</details>", "");
